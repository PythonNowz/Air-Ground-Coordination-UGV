...
class BaseControl:
    def __init__(self):
        ...
        self.sub_ackermann = bool(rospy.get_param('~sub_ackermann',True))
        ...
        #if move base type is ackermann car like robot and use ackermann msg, sub ackermann topic, else sub cmd_vel topic
